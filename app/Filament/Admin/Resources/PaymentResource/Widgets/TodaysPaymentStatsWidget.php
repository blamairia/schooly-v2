...
class TodaysPaymentStatsWidget extends BaseWidget
{
    ...
    protected function getCards(): array
    {
        ...
        return [
            Card::make('Total Revenue', number_format($totalRevenue, 2))->description('Total Paid Amount Today')->color('success'),
            Card::make('Total Due', number_format($totalDue, 2))->description('Total Due Today')->color('danger'),
