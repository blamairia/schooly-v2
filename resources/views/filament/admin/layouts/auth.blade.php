...
<body class="font-sans antialiased">
    <div class="min-h-screen flex">
        <!-- Left Panel - Branding & Image (narrower - 2/5 width) -->
        <div class="hidden lg:flex lg:w-2/5 bg-gradient-to-br from-blue-900 via-blue-800 to-indigo-900 relative overflow-hidden">
            <!-- Background Pattern -->
        ...
        <!-- Right Panel - Login Form (wider - 3/5 width) -->
        <div class="w-full lg:w-3/5 flex items-center justify-center p-8 bg-gray-50">
