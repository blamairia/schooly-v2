...
<head>
    ...
    <!-- Définir le titre avec des valeurs dynamiques -->
    <title>Reçu - {{ $payment->student->first_name }} {{ $payment->student->last_name }} - {{ $payment->total_amount }} DZD - {{ $payment->created_at->format('Ymd_His') }}</title>
